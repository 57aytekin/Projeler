package com.aytekincomez.recyclerview_multiplyviewholder.Adapter;
...
import com.aytekincomez.recyclerview_multiplyviewholder.Model.Call;
import com.aytekincomez.recyclerview_multiplyviewholder.Model.SMS;
import com.aytekincomez.recyclerview_multiplyviewholder.R;
...
public class CallSMSAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class CallViewHolder extends RecyclerView.ViewHolder {
        ...
        public CallViewHolder(View itemView) {
            ...
            callTimeTextView=(TextView)itemView.findViewById(R.id.callerTime);
        }

        public void showCallDetails(Call call){
            // Attach values for each item
            String callerName = call.getName();
            String callTime  =call.getTime();
